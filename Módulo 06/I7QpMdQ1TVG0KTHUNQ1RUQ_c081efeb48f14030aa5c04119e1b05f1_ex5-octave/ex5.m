...
%  lambda to see how the fit and learning curve change.
 ...
 % Hora de inicio (dibujar una curva de aprendizaje suave requiere más tiempo)
tic
 % Es 0 para el original, mejor efecto es para suavizar, lambda es 0.01
lambda = 0.01;
%lambda = 0;
